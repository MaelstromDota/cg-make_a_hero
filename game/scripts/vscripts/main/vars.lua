...
_G.INVENTORY_SLOTS = {DOTA_ITEM_SLOT_1, DOTA_ITEM_SLOT_2, DOTA_ITEM_SLOT_3, DOTA_ITEM_SLOT_4, DOTA_ITEM_SLOT_5, DOTA_ITEM_SLOT_6, DOTA_ITEM_TP_SCROLL, DOTA_ITEM_NEUTRAL_SLOT}
...
-- _G.NEUTRAL_ITEMS = NEUTRAL_ITEMS or {}
-- local neutral_items_info = LoadKeyValues("scripts/npc/neutral_items.txt")
-- for _, team in pairs(TEAMS) do
-- 	if NEUTRAL_ITEMS[team] == nil then
-- 		NEUTRAL_ITEMS[team] = {}
-- 		for tier, _ in pairs(neutral_items_info) do
-- 			NEUTRAL_ITEMS[team][tonumber(tier)] = {}
-- 		end
-- 	end
-- end
-- _G.NEUTRAL_ITEMS_PSEUDORANDOM_ID = 7777777
